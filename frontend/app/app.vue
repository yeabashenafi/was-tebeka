  ...
  <UApp :dir="selectedLanguage === 'ar' ? 'rtl' : 'ltr'">
    <div class="min-h-screen flex flex-col bg-gray-50 text-gray-900 font-sans selection:bg-primary-100" :dir="selectedLanguage === 'ar' ? 'rtl' : 'ltr'">
      ...
      <main class="pt-24 flex-1 flex flex-col">
        ...
        <section id="tracker-section" class="py-16">
    ...
    <UModal v-model:open="isReportModalOpen">
      <template #content>
        <UCard>
          <template #header>
            <div class="flex items-center justify-between">
              <h3 class="text-xl font-bold text-gray-900">Secure Incident Report</h3>
              <UButton color="gray" variant="ghost" icon="i-heroicons-x-mark" @click="isReportModalOpen = false" />
            </div>
          </template>
        ...
        <form v-else @submit.prevent="submitReport" class="space-y-4">
          ...
          <div class="pt-4 flex justify-end gap-3 border-t border-gray-100">
            <UButton color="gray" variant="ghost" @click="isReportModalOpen = false">Cancel</UButton>
...
const scrollToTracker = () => {
  ...
  if (el) {
    ...
    // optionally focus the input if you can get a ref, but scroll is enough
  }
}
