...
from .views import IncidentReportViewSet, AdminIncidentViewSet, AdminTimelineViewSet, AdminResponderOrgViewSet, PublicResponderOrgViewSet

router = DefaultRouter()
router.register(r'incidents', IncidentReportViewSet, basename='incident')
router.register(r'organizations', PublicResponderOrgViewSet, basename='organization')
